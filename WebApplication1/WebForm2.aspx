            ...
            <table class="auto-style2" style="margin-left:200px; font-size:20px;">
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        ...
                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="TextAmount" ErrorMessage="Invalid Input" ForeColor="#CC0000" MaximumValue="10" MinimumValue="1" CssClass="auto-style19"></asp:RangeValidator>
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style15" style="padding-top:15px;">
                        <asp:Button ID="btn1Report" runat="server" Font-Names="Bahnschrift" Font-Size="Large" ForeColor="#666666"  Text="Submit" Width="90px" />
                    </td>
